...
<body>
    <h1 align='center' style="margin: 15px; color:black;font-weight: bold;font-family:'Times New Roman', Times, serif">RESET YOUR PASSWORD</h1><hr/>
    ...
    <div><h5 ><a href="index.php" style="float: right; margin-right:40px; color:blue; margin-top:0px">SignIn</a></h5></div>
        <div class="container" style="margin-top: 60px; width:50%;">
            <div class="row">
                <div class="col-md-12">
                    <h2 style="color: #273c75;">ENTER YOUR EMAIL-ID</h2>
